@extends('backend.partials.app', ['title' => __('Update News')])
@push('css')
...
<div class="content-wrapper">
  ...
  'action' => route("news.update", $data->id),
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="titlenews" name="title" value="{{ $data->title }}">
  </div>
  <div class="mb-3">
  ...
  <div class="mb-3">
    <div class="form-group">
      ...
      <div class="input-group col-xs-12">
        <input type="text" class="form-control file-upload-info" disabled="" value="{{ $data->thumbnail }}" placeholder="Upload Image" >
  ...
  <div class="mb-3">
    ...
    <input name="tags" id="tagsInput" class="form-control" placeholder="write some tags" value="{{ $arrTags }}">
    @if ($errors->has('tags'))
  ...
  <div class="mb-3">
    ...
    <x-forms.tinymce-editor>{{ $data->content }}</x-forms.tinymce-editor>
  </div>
  @endslot
  @endcomponent

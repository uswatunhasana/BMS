@extends('backend.partials.app', ['title' => __('List News Trash')])
@push('pluginscss')
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        function deleteFunc(id) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: "news/forcedelete/" + id_forcenews,
                        data: {
                            _token: "{{ csrf_token() }}",
                            id: id_forcenews,
                        },
                        success: function(res) {
                            $(newsTrash).DataTable().ajax.reload(null, false);
                            Swal.fire({
                            title: 'Deleted',
                            icon: 'success',
        ...
        function restoreFunc(id) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "/trashdata/news/restore/" + id_user_restore,
                        data: {
                            _token: "{{ csrf_token() }}",
                            id: id_user_restore,
                        },
        ...
        var urlRestoreAll = "{{ route('restoreall.news') }}";
        function restoreAll() {
            Swal.fire({

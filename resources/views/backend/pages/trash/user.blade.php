@extends('backend.partials.app', ['title' => __('Lists Trash User')])
@push('pluginscss')
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        function deleteFunc(id) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: "user/forcedelete/" + id_user_trash,
                        data: {
                            _token: "{{ csrf_token() }}",
                            id: id_user_trash,
                        },
        ...
        function restoreFunc(id) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "/trashdata/user/restore/" + id_user_restore,
                        data: {
                            _token: "{{ csrf_token() }}",
                            id: id_user_restore,
                        },
        ...
        var urlRestoreAll = "{{ route('restoreall.user') }}";
        function restoreAll() {
            Swal.fire({
